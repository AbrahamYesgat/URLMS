...
public class ManageSupplyPage extends JFrame{
	...
	private void initComponents() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addContainerGap())
				.addComponent(headerPanel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 854, Short.MAX_VALUE)
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(headerPanel, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
		...
		lblManageSupply.setForeground(Color.WHITE);
		headerPanel.add(lblManageSupply, BorderLayout.CENTER);
		lblManageSupply.setHorizontalAlignment(SwingConstants.CENTER);
		lblManageSupply.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 26));
