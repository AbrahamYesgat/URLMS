...
public class TestCreateExpenseReport {
    ...
    public void test() {
        ...
        //Case 1: Director creates an expense report
        assertEquals(true, sysC.createExpenseReport("report", 10, 10, 10, 2017));

        //Case 2: Director creates an expense report with same name
        assertEquals(true, sysC.createExpenseReport("report", 10, 10, 10, 2017));

        //Case 3: Director creates an report with negative value
        assertEquals(false, sysC.createExpenseReport("report", -10, 10, 10, 2017));

        //Case 4: Director creates an expense report with 0 amount
        assertEquals(true, sysC.createExpenseReport("report", 0, 10, 10, 2017));
        ...
        //Case 5: Staff same tests
        //Case 5.1: Staff creates an expense report
        assertEquals(true, sysC.createExpenseReport("report", 10, 10, 10, 2017));

        //Case 5.2: Staff creates an expense report with same name
        assertEquals(true, sysC.createExpenseReport("report", 10, 10, 10, 2017));

        //Case 5.3: Staff creates an report with negative value
        assertEquals(false, sysC.createExpenseReport("report", -10, 10, 10, 2017));

        //Case 5.4: Staff creates an expense report with 0 amount
        assertEquals(true, sysC.createExpenseReport("report", 0, 10, 10, 2017));
    }
}
