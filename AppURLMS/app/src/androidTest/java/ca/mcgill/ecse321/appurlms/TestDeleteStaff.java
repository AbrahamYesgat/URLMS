...
public class TestDeleteStaff {
    ...
    public void test() {
        ...
        //Case 1: Successful staff delete
        assertEquals(true, sysC.removeStaff(testStaffEmail));

        //Case 2: Delete non existant staff
        assertEquals(false, sysC.removeStaff(testStaffEmail));

        //Case 3: Delete a director instead
        assertEquals(false, sysC.removeStaff(testEmail));
        ...
        //Case 4: Staff attempts to delete staff
        assertEquals(false, sysC.removeStaff(testStaffEmail));

        //Case 5: Delete a director instead
        assertEquals(false, sysC.removeStaff(testEmail));
    }
}
