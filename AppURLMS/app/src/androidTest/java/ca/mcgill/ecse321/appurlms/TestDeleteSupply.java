...
public class TestDeleteSupply {
    ...
    public void test() {
        ...
        assertEquals(true, sysC.removeSupplies("supply"));

        //Case 2: Director delete non existent supply
        assertEquals(false, sysC.removeSupplies("supply"));
        ...
        //Case 4: Staff delete non existent supply
        assertEquals(false, sysC.removeSupplies("supply"));
    }
}
